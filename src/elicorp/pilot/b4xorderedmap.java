...
public class b4xorderedmap extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "elicorp.pilot.b4xorderedmap");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", elicorp.pilot.b4xorderedmap.class).invoke(this, new Object[] {null});
        else
            ba.raiseEvent2(null, true, "class_globals", false);
    }

 public anywheresoftware.b4a.keywords.Common __c = null;
public anywheresoftware.b4a.objects.collections.Map _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = null;
public anywheresoftware.b4a.objects.collections.List _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 = null;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 3;BA.debugLine="Private list As List";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 = new anywheresoftware.b4a.objects.collections.List();
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.Clear();
 //BA.debugLineNum = 28;BA.debugLine="map.Clear";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4.Clear();
 //BA.debugLineNum = 29;BA.debugLine="End Sub";
return "";
}
public boolean  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4(Object _key) throws Exception{
...
if (true) return _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4.ContainsKey(_key);
 //BA.debugLineNum = 48;BA.debugLine="End Sub";
return false;
}
public Object  _vvvvvvvvvvvvvvvvvvvvvvvvvvvv5(Object _key) throws Exception{
 //BA.debugLineNum = 37;BA.debugLine="Public Sub Get (Key As Object) As Object";
 //BA.debugLineNum = 38;BA.debugLine="Return map.Get(Key)";
if (true) return _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4.Get(_key);
 //BA.debugLineNum = 39;BA.debugLine="End Sub";
return null;
}
public Object  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6() throws Exception{
...
if (true) return (Object)(new Object[]{(Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4.getObject()),(Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getObject())});
 //BA.debugLineNum = 67;BA.debugLine="End Sub";
return null;
}
public Object  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7(Object _key,Object _defaultvalue) throws Exception{
...
if (true) return _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4.GetDefault(_key,_defaultvalue);
 //BA.debugLineNum = 44;BA.debugLine="End Sub";
return null;
}
public anywheresoftware.b4a.objects.collections.List  _getvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0() throws Exception{
...
if (true) return _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4.getSize();
 //BA.debugLineNum = 52;BA.debugLine="End Sub";
return 0;
}
public anywheresoftware.b4a.objects.collections.List  _getvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3() throws Exception{
...
{
final anywheresoftware.b4a.BA.IterableList group3 = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5;
...
_res.Add(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4.Get(_key));
 }
};
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4.Initialize();
 //BA.debugLineNum = 8;BA.debugLine="list.Initialize";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.Initialize();
 //BA.debugLineNum = 9;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1(Object _key,Object _value) throws Exception{
...
if (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4.ContainsKey(_key)==__c.False) { 
 //BA.debugLineNum = 14;BA.debugLine="list.Add(Key)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.Add(_key);
 };
 //BA.debugLineNum = 16;BA.debugLine="map.Put(Key, Value)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4.Put(_key,_value);
 //BA.debugLineNum = 17;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4(Object _key) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.RemoveAt(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.IndexOf(_key));
 //BA.debugLineNum = 23;BA.debugLine="map.Remove(Key)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4.Remove(_key);
 //BA.debugLineNum = 24;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2(Object _data) throws Exception{
Object[] _o = null;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_o[(int) (0)]));
 //BA.debugLineNum = 73;BA.debugLine="list = o(1)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 = (anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_o[(int) (1)]));
