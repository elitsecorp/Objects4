...
public class httpjob extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "elicorp.pilot.httpjob");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", elicorp.pilot.httpjob.class).invoke(this, new Object[] {null});
        else
            ba.raiseEvent2(null, true, "class_globals", false);
    }

 public anywheresoftware.b4a.keywords.Common __c = null;
public String _vvvvvvvvvvvvvvvvvvvvvvv7 = "";
public boolean _vvvvvvvvvvvvvvvvvvvvvvv0 = false;
public String _vvvvvvvvvvvvvvvvvvvvvvvv1 = "";
public String _vvvvvvvvvv5 = "";
public String _vvvvvvvvvvvvvvvvvvvvvvvv2 = "";
public Object _vvvvvvvvvvvvvvvvvvvvvvvv3 = null;
public String _vvvvvvvvvvvvvvvvvvvvvvvv4 = "";
public anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest _vvvvvvvvvvvvvvvvvvvvvvvv5 = null;
public anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpResponse _vvvvvvvvvvvvvvvvvvvvvvvv6 = null;
...
public String  _vvvvvvvvvvvvvvvvvvvv7(String _link) throws Exception{
...
if ((_vvvvvvvvvvvvvvvvvvvvvvvvv1).equals("") || _link.contains(":")) { 
if (true) return _link;};
 //BA.debugLineNum = 45;BA.debugLine="Return DefaultScheme & \"://\" & Link";
if (true) return _vvvvvvvvvvvvvvvvvvvvvvvvv1+"://"+_link;
...
_vvvvvvvvvvvvvvvvvvvvvvv0 = false;
...
_vvvvvvvvvvvvvvvvvvvvvvvv3 = new Object();
...
_vvvvvvvvvvvvvvvvvvvvvvvv5 = new anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest();
 //BA.debugLineNum = 16;BA.debugLine="Public Response As OkHttpResponse";
_vvvvvvvvvvvvvvvvvvvvvvvv6 = new anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpResponse();
...
_vvvvvvvvvvvvvvvvvvvvvvvv0 = "https://invalid-url/";
 //BA.debugLineNum = 31;BA.debugLine="Public DefaultScheme As String = \"https\"";
_vvvvvvvvvvvvvvvvvvvvvvvvv1 = "https";
...
_vvvvvvvvvvvvvvvvvvvvvvvv4 = BA.NumberToString(_id);
 //BA.debugLineNum = 308;BA.debugLine="CallSubDelayed2(target, \"JobDone\", Me)";
__c.CallSubDelayed2(ba,_vvvvvvvvvvvvvvvvvvvvvvvv3,"JobDone",this);
 //BA.debugLineNum = 309;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvv0(String _link) throws Exception{
...
_link = _vvvvvvvvvvvvvvvvvvvv7(_link);
 //BA.debugLineNum = 255;BA.debugLine="req.InitializeDelete(Link)";
_vvvvvvvvvvvvvvvvvvvvvvvv5.InitializeDelete(_link);
 } 
       catch (Exception e5) {
...
_vvvvvvvvvvvvvvvvvvvvvvvv5.InitializeDelete(_vvvvvvvvvvvvvvvvvvvvvvvv0);
 };
 //BA.debugLineNum = 260;BA.debugLine="CallSubDelayed2(HttpUtils2Service, \"SubmitJob\", M";
__c.CallSubDelayed2(ba,(Object)(_vvvvvvvvvvvv3.getObject()),"SubmitJob",this);
 //BA.debugLineNum = 261;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvv1(String _link,String[] _parameters) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvv5.InitializeDelete(_vvvvvvvvvvvvvvvvvvvvv4(_link,_parameters));
 } 
       catch (Exception e5) {
			ba.setLastException(e5); //BA.debugLineNum = 268;BA.debugLine="Log($\"Invalid link: ${Link}\"$)";
__c.LogImpl("98847365",("Invalid link: "+__c.SmartStringFormatter("",(Object)(_link))+""),0);
 //BA.debugLineNum = 269;BA.debugLine="req.InitializeDelete(escapeLink(InvalidURL, Para";
_vvvvvvvvvvvvvvvvvvvvvvvv5.InitializeDelete(_vvvvvvvvvvvvvvvvvvvvv4(_vvvvvvvvvvvvvvvvvvvvvvvv0,_parameters));
 };
...
public String  _vvvvvvvvvvvvvvvvvvvvv2(String _link) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvv5.InitializeGet(_link);
 } 
       catch (Exception e5) {
...
_vvvvvvvvvvvvvvvvvvvvvvvv5.InitializeGet(_vvvvvvvvvvvvvvvvvvvvvvvv0);
 };
...
public String  _vvvvvvvvvvvvvvvvvvvvv3(String _link,String[] _parameters) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvv5.InitializeGet(_vvvvvvvvvvvvvvvvvvvvv4(_link,_parameters));
 } 
       catch (Exception e5) {
...
_vvvvvvvvvvvvvvvvvvvvvvvv5.InitializeGet(_vvvvvvvvvvvvvvvvvvvvv4(_vvvvvvvvvvvvvvvvvvvvvvvv0,_parameters));
 };
...
public String  _vvvvvvvvvvvvvvvvvvvvv4(String _link,String[] _parameters) throws Exception{
...
public anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper  _vvvvvvvvvvvvvvvvvvvvv5() throws Exception{
...
_b = __c.LoadBitmap(_vvvvvvvvvvvv3._v5 /*String*/ ,_vvvvvvvvvvvvvvvvvvvvvvvv4);
 //BA.debugLineNum = 324;BA.debugLine="Return b";
if (true) return _b;
 //BA.debugLineNum = 325;BA.debugLine="End Sub";
return null;
}
public anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper  _vvvvvvvvvvvvvvvvvvvvv6(int _width,int _height,boolean _keepaspectratio) throws Exception{
...
if (true) return __c.LoadBitmapResize(_vvvvvvvvvvvv3._v5 /*String*/ ,_vvvvvvvvvvvvvvvvvvvvvvvv4,_width,_height,_keepaspectratio);
 //BA.debugLineNum = 334;BA.debugLine="End Sub";
return null;
}
public anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper  _vvvvvvvvvvvvvvvvvvvvv7(int _width,int _height) throws Exception{
...
if (true) return __c.LoadBitmapSample(_vvvvvvvvvvvv3._v5 /*String*/ ,_vvvvvvvvvvvvvvvvvvvvvvvv4,_width,_height);
 //BA.debugLineNum = 330;BA.debugLine="End Sub";
return null;
}
public anywheresoftware.b4a.objects.streams.File.InputStreamWrapper  _vvvvvvvvvvvvvvvvvvvvv0() throws Exception{
...
_in = __c.File.OpenInput(_vvvvvvvvvvvv3._v5 /*String*/ ,_vvvvvvvvvvvvvvvvvvvvvvvv4);
 //BA.debugLineNum = 341;BA.debugLine="Return In";
if (true) return _in;
 //BA.debugLineNum = 342;BA.debugLine="End Sub";
return null;
}
public anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest  _vvvvvvvvvvvvvvvvvvvvvv1() throws Exception{
 //BA.debugLineNum = 301;BA.debugLine="Public Sub GetRequest As OkHttpRequest";
 //BA.debugLineNum = 302;BA.debugLine="Return req";
if (true) return _vvvvvvvvvvvvvvvvvvvvvvvv5;
...
if (true) return _vvvvvvvvvvvvvvvvvvvvvv3("UTF8");
 //BA.debugLineNum = 284;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvv3(String _encoding) throws Exception{
...
_tr.Initialize2((java.io.InputStream)(__c.File.OpenInput(_vvvvvvvvvvvv3._v5 /*String*/ ,_vvvvvvvvvvvvvvvvvvvvvvvv4).getObject()),_encoding);
...
public String  _vvvvvvvvvvvvvvvvvvvvvv4(String _link) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvv5.InitializeHead(_link);
 } 
       catch (Exception e5) {
...
_vvvvvvvvvvvvvvvvvvvvvvvv5.InitializeHead(_vvvvvvvvvvvvvvvvvvvvvvvv0);
 };
...
_vvvvvvvvvvvvvvvvvvvvvvv7 = _name;
 //BA.debugLineNum = 40;BA.debugLine="target = TargetModule";
_vvvvvvvvvvvvvvvvvvvvvvvv3 = _targetmodule;
 //BA.debugLineNum = 41;BA.debugLine="End Sub";
return "";
}
public boolean  _vvvvvvvvvvvvvvvvvvvvvv5(anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper _stream,boolean _empty) throws Exception{
...
public String  _vvvvvvvvvvvvvvvvvvvvvv6(String _link,byte[] _data) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvv5.InitializePatch2(_link,_data);
 } 
       catch (Exception e5) {
			ba.setLastException(e5); //BA.debugLineNum = 100;BA.debugLine="Log($\"Invalid link: ${Link}\"$)";
__c.LogImpl("98257548",("Invalid link: "+__c.SmartStringFormatter("",(Object)(_link))+""),0);
 //BA.debugLineNum = 101;BA.debugLine="req.InitializePatch2(InvalidURL, Data)";
_vvvvvvvvvvvvvvvvvvvvvvvv5.InitializePatch2(_vvvvvvvvvvvvvvvvvvvvvvvv0,_data);
 };
...
public String  _vvvvvvvvvvvvvvvvvvvvvv7(String _link,String _text) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvv6(_link,_text.getBytes("UTF8"));
 //BA.debugLineNum = 85;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvv0(String _link,byte[] _data) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvv5.InitializePost2(_link,_data);
 } 
       catch (Exception e5) {
...
_vvvvvvvvvvvvvvvvvvvvvvvv5.InitializePost2(_vvvvvvvvvvvvvvvvvvvvvvvv0,_data);
 };
...
public String  _vvvvvvvvvvvvvvvvvvvvvvv1(String _link,String _dir,String _filename) throws Exception{
int _length = 0;
anywheresoftware.b4a.objects.streams.File.InputStreamWrapper _in = null;
...
__c.LogImpl("98519688","Cannot send files from the assets folder.",0);
...
_vvvvvvvvvvvvvvvvvvvvvv0(_link,_out.ToBytesArray());
 }else {
 //BA.debugLineNum = 203;BA.debugLine="req.InitializePost(Link, In, length)";
_vvvvvvvvvvvvvvvvvvvvvvvv5.InitializePost(_link,(java.io.InputStream)(_in.getObject()),_length);
...
public String  _vvvvvvvvvvvvvvvvvvvvvvv2(String _link,anywheresoftware.b4a.objects.collections.Map _namevalues,anywheresoftware.b4a.objects.collections.List _files) throws Exception{
String _boundary = "";
...
String _value = "";
String _s = "";
elicorp.pilot.httpjob._multipartfiledata _fd = null;
anywheresoftware.b4a.objects.streams.File.InputStreamWrapper _in = null;
...
_empty = _vvvvvvvvvvvvvvvvvvvvvv5(_stream,_empty);
...
_fd = (elicorp.pilot.httpjob._multipartfiledata)(group17.Get(index17));
...
_vvvvvvvvvvvvvvvvvvvvvv0(_link,_stream.ToBytesArray());
 //BA.debugLineNum = 166;BA.debugLine="req.SetContentType(\"multipart/form-data; boundary";
_vvvvvvvvvvvvvvvvvvvvvvvv5.SetContentType("multipart/form-data; boundary="+_boundary);
 //BA.debugLineNum = 167;BA.debugLine="req.SetContentEncoding(\"UTF8\")";
_vvvvvvvvvvvvvvvvvvvvvvvv5.SetContentEncoding("UTF8");
 //BA.debugLineNum = 168;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvv3(String _link,String _text) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvv0(_link,_text.getBytes("UTF8"));
 //BA.debugLineNum = 51;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvv4(String _link,byte[] _data) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvv5.InitializePut2(_link,_data);
 } 
       catch (Exception e5) {
...
_vvvvvvvvvvvvvvvvvvvvvvvv5.InitializePut2(_vvvvvvvvvvvvvvvvvvvvvvvv0,_data);
 };
...
public String  _vvvvvvvvvvvvvvvvvvvvvvv5(String _link,String _text) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvv4(_link,_text.getBytes("UTF8"));
 //BA.debugLineNum = 68;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvv6() throws Exception{
...
__c.File.Delete(_vvvvvvvvvvvv3._v5 /*String*/ ,_vvvvvvvvvvvvvvvvvvvvvvvv4);
