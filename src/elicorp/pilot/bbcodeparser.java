...
public class bbcodeparser extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "elicorp.pilot.bbcodeparser");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", elicorp.pilot.bbcodeparser.class).invoke(this, new Object[] {null});
        else
            ba.raiseEvent2(null, true, "class_globals", false);
    }

 public anywheresoftware.b4a.keywords.Common __c = null;
public elicorp.pilot.b4xset _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 = null;
public anywheresoftware.b4a.objects.collections.List _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = null;
...
public anywheresoftware.b4a.keywords.StringBuilderWrapper _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = null;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 = new elicorp.pilot.b4xset();
 //BA.debugLineNum = 7;BA.debugLine="Private Stack As List";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = new anywheresoftware.b4a.objects.collections.List();
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 = ((int)0xff003fff);
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = new anywheresoftware.b4a.keywords.StringBuilderWrapper();
 //BA.debugLineNum = 15;BA.debugLine="End Sub";
return "";
}
public anywheresoftware.b4a.objects.collections.List  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1(anywheresoftware.b4a.objects.collections.List _texts,elicorp.pilot.bbcodeparser._bbcodeparsedata _data) throws Exception{
anywheresoftware.b4a.objects.collections.List _runs = null;
elicorp.pilot.bbcodeparser._bbcodetextnode _textnode = null;
...
_textnode = (elicorp.pilot.bbcodeparser._bbcodetextnode)(group3.Get(index3));
 //BA.debugLineNum = 186;BA.debugLine="TextToRun(TextNode, Runs, Data)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0(_textnode,_runs,_data);
 }
};
...
public elicorp.pilot.bbcodeparser._bbcodetagnode  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2(String _tag) throws Exception{
elicorp.pilot.bbcodeparser._bbcodetagnode _n = null;
...
_n = new elicorp.pilot.bbcodeparser._bbcodetagnode();
...
public elicorp.pilot.bbcodeparser._bbcodetextnode  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3(String _text) throws Exception{
elicorp.pilot.bbcodeparser._bbcodetextnode _n = null;
...
_n = new elicorp.pilot.bbcodeparser._bbcodetextnode();
...
_n.Tags /*anywheresoftware.b4a.objects.collections.List*/ .AddAll(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2);
 //BA.debugLineNum = 170;BA.debugLine="Return n";
if (true) return _n;
 //BA.debugLineNum = 171;BA.debugLine="End Sub";
return null;
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4(String _msg) throws Exception{
String _s = "";
...
_s = ("Error (position - "+__c.SmartStringFormatter("",(Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3))+"): "+__c.SmartStringFormatter("",(Object)(_msg))+"");
 //BA.debugLineNum = 157;BA.debugLine="LogColor(s, Colors.Red)";
__c.LogImpl("923199747",_s,__c.Colors.Red);
 //BA.debugLineNum = 161;BA.debugLine="ErrorString.Append(s).Append(CRLF)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.Append(_s).Append(__c.CRLF);
 //BA.debugLineNum = 162;BA.debugLine="End Sub";
return "";
}
public int  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5(elicorp.pilot.bbcodeparser._bbcodetagnode _tag,String _key,elicorp.pilot.bbcodeparser._bbcodeparsedata _data) throws Exception{
String _s = "";
int _i = 0;
float _v = 0f;
...
public anywheresoftware.b4a.objects.B4XViewWrapper  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6(elicorp.pilot.bbcodeparser._bbcodetagnode _tag,elicorp.pilot.bbcodeparser._bbcodeparsedata _data) throws Exception{
String _id = "";
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4("Missing view: "+_id);
 };
...
public elicorp.pilot.bctextengine._bctextrun  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7(elicorp.pilot.bbcodeparser._bbcodetextnode _text,elicorp.pilot.bctextengine._bctextrun _run) throws Exception{
int _i = 0;
elicorp.pilot.bbcodeparser._bbcodetagnode _tag = null;
String _liststyle = "";
int _count = 0;
...
_tag = (elicorp.pilot.bbcodeparser._bbcodetagnode)(_text.Tags /*anywheresoftware.b4a.objects.collections.List*/ .Get(_i));
...
_run.TextChars /*elicorp.pilot.bctextengine._bctextchars*/  = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 /*elicorp.pilot.bctextengine._bctextchars*/ (BA.ObjectToString(__c.Chr(((int)0x2022)))+" ");
 }else {
...
_parent = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 /*elicorp.pilot.bctextengine._bctextrun*/ ();
 //BA.debugLineNum = 355;BA.debugLine="Run.TextChars = mTextEngine.CreateBCTextCharsF";
_run.TextChars /*elicorp.pilot.bctextengine._bctextchars*/  = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 /*elicorp.pilot.bctextengine._bctextchars*/ (BA.NumberToString((_count))+". ");
 //BA.debugLineNum = 356;BA.debugLine="Dim cr As BCConnectedRuns = parent.Extra.Get(m";
_cr = (elicorp.pilot.bctextengine._bcconnectedruns)(_parent.Extra /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4._extra_connectedruns /*String*/ )));
...
_cr.ConnectedWidth /*int*/  = (int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 /*elicorp.pilot.bctextengine._bcfontmetrics*/ (_run.TextFont /*anywheresoftware.b4a.objects.B4XViewWrapper.B4XFont*/ ,_run.TextColor /*int*/ ).xWidth /*int*/ *3/(double)_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 /*float*/ );
...
public String  _initialize(anywheresoftware.b4a.BA _ba,elicorp.pilot.bctextengine _textengine) throws Exception{
innerInitialize(_ba);
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 = _vvvvvvvvvvvv5._vvvv2 /*elicorp.pilot.b4xset*/ (ba,anywheresoftware.b4a.keywords.Common.ArrayToList(new Object[]{(Object)("b"),(Object)("u"),(Object)("url"),(Object)("plain"),(Object)("color"),(Object)("img"),(Object)("view"),(Object)("vertical"),(Object)("textsize"),(Object)("alignment"),(Object)("span"),(Object)("indent"),(Object)("list"),(Object)("*"),(Object)("fontawesome"),(Object)("materialicons"),(Object)("e"),(Object)("font"),(Object)("direction")}));
 //BA.debugLineNum = 21;BA.debugLine="ColorsMap = CreateMap(\"black\": xui.Color_Black, _";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 = __c.createMap(new Object[] {(Object)("black"),(Object)(_vvvvvvvvv6.Color_Black),(Object)("darkgray"),(Object)(_vvvvvvvvv6.Color_DarkGray),(Object)("gray"),(Object)(_vvvvvvvvv6.Color_Gray),(Object)("lightgray"),(Object)(_vvvvvvvvv6.Color_LightGray),(Object)("white"),(Object)(_vvvvvvvvv6.Color_White),(Object)("red"),(Object)(_vvvvvvvvv6.Color_Red),(Object)("green"),(Object)(_vvvvvvvvv6.Color_Green),(Object)("blue"),(Object)(_vvvvvvvvv6.Color_Blue),(Object)("yellow"),(Object)(_vvvvvvvvv6.Color_Yellow),(Object)("cyan"),(Object)(_vvvvvvvvv6.Color_Cyan),(Object)("magenta"),(Object)(_vvvvvvvvv6.Color_Magenta),(Object)("transparent"),(Object)(_vvvvvvvvv6.Color_Transparent)});
 //BA.debugLineNum = 33;BA.debugLine="mTextEngine = TextEngine";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = _textengine;
 //BA.debugLineNum = 34;BA.debugLine="ErrorString.Initialize";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.Initialize();
 //BA.debugLineNum = 35;BA.debugLine="End Sub";
return "";
}
public anywheresoftware.b4a.objects.collections.List  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0(elicorp.pilot.bbcodeparser._bbcodeparsedata _data) throws Exception{
...
elicorp.pilot.bbcodeparser._bbcodetagnode _t = null;
elicorp.pilot.bbcodeparser._bbcodetagnode _n = null;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2.Initialize();
 //BA.debugLineNum = 42;BA.debugLine="Stack.Add(CreateTagNode(\"noop\"))";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2.Add((Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2("noop")));
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = _matcher.GetStart((int) (0));
 //BA.debugLineNum = 48;BA.debugLine="If Start > LastMatchEnd And skipUntilEndTag = Fa";
if (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3>_lastmatchend && _skipuntilendtag==__c.False) { 
 //BA.debugLineNum = 49;BA.debugLine="ParsedElements.Add(CreateTextNode(Data.Text.Sub";
_parsedelements.Add((Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3(_data.Text /*String*/ .substring(_lastmatchend,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3))));
 };
...
if ((_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5().Tag /*String*/ ).equals(_tag) == false) { 
 //BA.debugLineNum = 55;BA.debugLine="If StackPeek.CanHaveNestedTags = False Then";
if (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5().CanHaveNestedTags /*boolean*/ ==__c.False) { 
 //BA.debugLineNum = 56;BA.debugLine="Continue";
if (true) continue;
 };
 //BA.debugLineNum = 58;BA.debugLine="Error(\"Closing tag does not match: \" & tag)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4("Closing tag does not match: "+_tag);
...
_t = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3(_tag);
 //BA.debugLineNum = 79;BA.debugLine="If AllowedTags.Contains(t.Tag) = False Then";
if (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 /*boolean*/ ((Object)(_t.Tag /*String*/ ))==__c.False) { 
 //BA.debugLineNum = 80;BA.debugLine="Error(\"Invalid tag: \" & tag)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4("Invalid tag: "+_tag);
 //BA.debugLineNum = 81;BA.debugLine="Return Null";
if (true) return (anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(__c.Null));
 };
 //BA.debugLineNum = 83;BA.debugLine="StackPush(t)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7(_t);
...
_n = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5();
...
_parsedelements.Add((Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3("")));
...
_parsedelements.Add((Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3(_data.Text /*String*/ .substring(_lastmatchend,_data.Text /*String*/ .length()))));
 };
...
public int  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1(String _raw) throws Exception{
...
public int  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2(String _clr) throws Exception{
...
if (true) return __c.Bit.Or(((int)0xff000000),__c.Bit.ParseInt(_clr.substring((int) (4)),(int) (16)));
 }else if(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6.ContainsKey((Object)(_clr))) { 
 //BA.debugLineNum = 337;BA.debugLine="Return ColorsMap.Get(clr)";
if (true) return (int)(BA.ObjectToNumber(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6.Get((Object)(_clr))));
 }else {
 //BA.debugLineNum = 339;BA.debugLine="Error(\"Invalid color value: \" & clr)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4("Invalid color value: "+_clr);
 //BA.debugLineNum = 340;BA.debugLine="Return xui.Color_Black";
if (true) return _vvvvvvvvv6.Color_Black;
 };
 //BA.debugLineNum = 342;BA.debugLine="End Sub";
return 0;
}
public elicorp.pilot.bbcodeparser._bbcodetagnode  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3(String _tag) throws Exception{
elicorp.pilot.bbcodeparser._bbcodetagnode _res = null;
int _i = 0;
int _last = 0;
String _c = "";
String _key = "";
...
if (true) return _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2(_tag.toLowerCase());};
 //BA.debugLineNum = 107;BA.debugLine="Dim res As BBCodeTagNode = CreateTagNode(\"\")";
_res = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2("");
...
public void  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4(elicorp.pilot.bbcodeparser._bbcodetagnode _tag,elicorp.pilot.bctextengine._bctextrun _run,elicorp.pilot.bbcodeparser._bbcodeparsedata _data) throws Exception{
...
public ResumableSub_SetImageView(elicorp.pilot.bbcodeparser parent,elicorp.pilot.bbcodeparser._bbcodetagnode _tag,elicorp.pilot.bctextengine._bctextrun _run,elicorp.pilot.bbcodeparser._bbcodeparsedata _data) {
this.parent = parent;
this._tag = _tag;
this._run = _run;
this._data = _data;
}
elicorp.pilot.bbcodeparser parent;
elicorp.pilot.bbcodeparser._bbcodetagnode _tag;
elicorp.pilot.bctextengine._bctextrun _run;
elicorp.pilot.bbcodeparser._bbcodeparsedata _data;
String _url = "";
String _dir = "";
String _filename = "";
int _width = 0;
...
_width = parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5(_tag,"width",_data);
 //BA.debugLineNum = 397;BA.debugLine="Dim height As Int = GetDimensionFromTag(Tag, \"hei";
_height = parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5(_tag,"height",_data);
...
_bmp = (anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper(), (android.graphics.Bitmap)(_j._vvvvvvvvvvvvvvvvvvvvv5 /*anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper*/ ().getObject()));
...
_bmp = parent._vvvvvvvvv6.LoadBitmap(_dir,_filename);
 if (true) break;
...
_bmp = parent._vvvvvvvvv6.LoadBitmapResize(_dir,_filename,_width,_height,parent.__c.False);
 if (true) break;
...
_bmp = parent._vvvvvvvvv6.LoadBitmapResize(_dir,_filename,_width,(int) (10000),parent.__c.True);
 if (true) break;
...
_bmp = parent._vvvvvvvvv6.LoadBitmapResize(_dir,_filename,(int) (10000),_height,parent.__c.True);
 if (true) break;
...
public elicorp.pilot.bbcodeparser._bbcodetagnode  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5() throws Exception{
...
if (true) return (elicorp.pilot.bbcodeparser._bbcodetagnode)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2.Get((int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2.getSize()-1)));
 //BA.debugLineNum = 152;BA.debugLine="End Sub";
return null;
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6() throws Exception{
 //BA.debugLineNum = 142;BA.debugLine="Private Sub StackPop";
 //BA.debugLineNum = 143;BA.debugLine="Stack.RemoveAt(Stack.Size - 1)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2.RemoveAt((int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2.getSize()-1));
 //BA.debugLineNum = 144;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7(elicorp.pilot.bbcodeparser._bbcodetagnode _tag) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2.Add((Object)(_tag));
 //BA.debugLineNum = 148;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0(elicorp.pilot.bbcodeparser._bbcodetextnode _text,anywheresoftware.b4a.objects.collections.List _runslist,elicorp.pilot.bbcodeparser._bbcodeparsedata _data) throws Exception{
...
int _i = 0;
elicorp.pilot.bbcodeparser._bbcodetagnode _tag = null;
elicorp.pilot.bctextengine._bcstyledunderline _uu = null;
String _url = "";
String _clr = "";
String _name = "";
...
_run = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 /*elicorp.pilot.bctextengine._bctextrun*/ (_text.Text /*String*/ );
...
_uu = new elicorp.pilot.bctextengine._bcstyledunderline();
 //BA.debugLineNum = 207;BA.debugLine="uu.Initialize";
_uu.Initialize();
 //BA.debugLineNum = 208;BA.debugLine="uu.Style = tag.Extra.GetDefault(\"style\", mTex";
_uu.Style /*String*/  = BA.ObjectToString(_tag.Extra /*anywheresoftware.b4a.objects.collections.Map*/ .GetDefault((Object)("style"),(Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 /*elicorp.pilot.bctextengine._bcstyledunderline*/ .Style /*String*/ )));
...
_uu.Clr /*int*/  = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2(BA.ObjectToString(_tag.Extra /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)("color"))));}
else {
_uu.Clr /*int*/  = (int) (0);};
...
_run.Extra /*anywheresoftware.b4a.objects.collections.Map*/ .Put((Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4._extra_styledunderline /*String*/ ),(Object)(_uu));
 };
 break; }
case 1: {
...
_run.TextDirection /*int*/  = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 /*int*/ ;
 };
...
_run.TextColor /*int*/  = __c.Bit.Or(((int)0xff000000),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5);
 break; }
case 3: {
...
_run.TextColor /*int*/  = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2(_clr);
 break; }
case 4: {
 //BA.debugLineNum = 233;BA.debugLine="SetImageView(tag, Run, Data)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4(_tag,_run,_data);
...
_run.VerticalOffset /*int*/  = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5(_tag,"vertical",_data);
 };
...
_run.View /*anywheresoftware.b4a.objects.B4XViewWrapper*/  = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6(_tag,_data);
...
_run.View /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setWidth(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5(_tag,"width",_data));};
...
_run.View /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setHeight(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5(_tag,"height",_data));};
...
if (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 /*anywheresoftware.b4a.objects.collections.Map*/ .ContainsKey((Object)(_name))==__c.False) { 
 //BA.debugLineNum = 252;BA.debugLine="Log(\"Font missing from TextEngine.CustomFonts";
__c.LogImpl("923461949","Font missing from TextEngine.CustomFonts: "+_name,0);
 }else {
 //BA.debugLineNum = 254;BA.debugLine="Dim NewFont As B4XFont =  mTextEngine.CustomF";
_newfont = (anywheresoftware.b4a.objects.B4XViewWrapper.B4XFont)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)(_name)));
...
_cr.ConnectedWidth /*int*/  = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5(_tag,"minwidth",_data);
...
_parent = (elicorp.pilot.bctextengine._bctextrun)(_tag.Extra /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)("run")));
...
_run.TextChars /*elicorp.pilot.bctextengine._bctextchars*/  = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 /*elicorp.pilot.bctextengine._bctextchars*/ (new String[]{BA.ObjectToString(_tag.Extra /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)(_tag.Tag /*String*/ )))},(int) (0),(int) (1));
...
_run.TextDirection /*int*/  = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 /*int*/ ;
 break; }
case 2: {
 //BA.debugLineNum = 289;BA.debugLine="Run.TextDirection = mTextEngine.TextDirectio";
_run.TextDirection /*int*/  = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 /*int*/ ;
 break; }
}
;
 break; }
...
_currentfont = _vvvvvvvvv6.CreateFontAwesome((float) (_fontsize));
 }else {
 //BA.debugLineNum = 296;BA.debugLine="CurrentFont = xui.CreateMaterialIcons(FontSiz";
_currentfont = _vvvvvvvvv6.CreateMaterialIcons((float) (_fontsize));
 };
 //BA.debugLineNum = 298;BA.debugLine="Run.TextChars = mTextEngine.CreateBCTextCharsF";
_run.TextChars /*elicorp.pilot.bctextengine._bctextchars*/  = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 /*elicorp.pilot.bctextengine._bctextchars*/ (BA.ObjectToString(__c.Chr(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1(BA.ObjectToString(_tag.Extra /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)(_tag.Tag /*String*/ )))))));
...
_run = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7(_text,_run);
 };
...
_run.TextFont /*anywheresoftware.b4a.objects.B4XViewWrapper.B4XFont*/  = _vvvvvvvvv6.CreateFont2(_currentfont,(float) (_fontsize));
 };
