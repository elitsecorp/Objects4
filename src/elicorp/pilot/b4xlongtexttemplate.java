...
public class b4xlongtexttemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "elicorp.pilot.b4xlongtexttemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", elicorp.pilot.b4xlongtexttemplate.class).invoke(this, new Object[] {null});
        else
...
public Object _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = null;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = new Object();
...
_vvvvvvvvvvvvvvvv1.LoadLayout("LongTextTemplate",ba);
...
_customlistview1._addtextitem(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7,(Object)(""));
...
_vvvvvvvvvvvv7._vvvvvvv1 /*String*/ (ba,_customlistview1,_customlistview1._defaulttextbackgroundcolor);
