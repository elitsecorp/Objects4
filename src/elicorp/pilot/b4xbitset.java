...
public class b4xbitset extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "elicorp.pilot.b4xbitset");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", elicorp.pilot.b4xbitset.class).invoke(this, new Object[] {null});
        else
            ba.raiseEvent2(null, true, "class_globals", false);
    }

 public anywheresoftware.b4a.keywords.Common __c = null;
public int[] _vvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 = null;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 = new int[(int) (0)];
;
 //BA.debugLineNum = 7;BA.debugLine="Private mSize As Int";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = 0;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 = new int[(int) (__c.Bit.ShiftRight(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvv2,(int) (5))+1)];
;
 //BA.debugLineNum = 60;BA.debugLine="End Sub";
return "";
}
public boolean  _vvvvvvvvvvvvvvvvvvvvvvvvvvvv5(int _index) throws Exception{
int _dindex = 0;
int _offset = 0;
int _blockvalue = 0;
...
_blockvalue = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvv1[_dindex];
...
if (true) return _vvvvvvvvvvvvvvvvvvvvvvvvvvvvv2;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = _size;
 //BA.debugLineNum = 12;BA.debugLine="Clear";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvv4();
 //BA.debugLineNum = 13;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvv7(int _index,boolean _value) throws Exception{
int _dindex = 0;
int _offset = 0;
int _blockvalue = 0;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvv1[_dindex] = _newblockvalue;
