...
public class b4xpagesdelegator extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "elicorp.pilot.b4xpagesdelegator");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", elicorp.pilot.b4xpagesdelegator.class).invoke(this, new Object[] {null});
        else
...
_vvvvvvvvvvvv4._vv4 /*elicorp.pilot.b4xpagesmanager*/ (getActivityBA())._activity_actionbarhomeclick /*String*/ ();
...
if (true) return _vvvvvvvvvvvv4._vv4 /*elicorp.pilot.b4xpagesmanager*/ (getActivityBA())._activity_keypress /*boolean*/ (_keycode);
...
_vvvvvvvvvvvv4._vv4 /*elicorp.pilot.b4xpagesmanager*/ (getActivityBA())._activity_pause /*String*/ ();
...
_vvvvvvvvvvvv4._vv4 /*elicorp.pilot.b4xpagesmanager*/ (getActivityBA())._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 /*String*/ (_vvvvvvvvvvvv4._vv4 /*elicorp.pilot.b4xpagesmanager*/ (getActivityBA())._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 /*elicorp.pilot.b4xpagesmanager._b4xpageinfo*/ (),"B4XPage_PermissionResult",new Object[]{(Object)(_permission),(Object)(_result)});
...
_vvvvvvvvvvvv4._vv4 /*elicorp.pilot.b4xpagesmanager*/ (getActivityBA())._activity_resume /*String*/ ();
...
_vvvvvvvvvvvv4._vv4 /*elicorp.pilot.b4xpagesmanager*/ (getActivityBA())._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 /*String*/ (_menu);
...
_vvvvvvvvvvvv4._vv4 /*elicorp.pilot.b4xpagesmanager*/ (getActivityBA())._mainform_resize /*String*/ (_width,_height);
