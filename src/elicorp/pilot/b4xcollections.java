...
public static elicorp.pilot.b4xbitset  _vvv6(anywheresoftware.b4a.BA _ba,int _size) throws Exception{
elicorp.pilot.b4xbitset _s = null;
...
_s = new elicorp.pilot.b4xbitset();
...
public static elicorp.pilot.b4xorderedmap  _vvv7(anywheresoftware.b4a.BA _ba) throws Exception{
...
if (true) return _vvv0(_ba,(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(anywheresoftware.b4a.keywords.Common.Null)),(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(anywheresoftware.b4a.keywords.Common.Null)));
 //BA.debugLineNum = 32;BA.debugLine="End Sub";
return null;
}
public static elicorp.pilot.b4xorderedmap  _vvv0(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.collections.List _keys,anywheresoftware.b4a.objects.collections.List _values) throws Exception{
elicorp.pilot.b4xorderedmap _m = null;
int _i = 0;
...
_m = new elicorp.pilot.b4xorderedmap();
...
_m._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 /*String*/ (_keys.Get(_i),_values.Get(_i));
 }
};
 };
...
public static elicorp.pilot.b4xset  _vvvv1(anywheresoftware.b4a.BA _ba) throws Exception{
 //BA.debugLineNum = 9;BA.debugLine="Public Sub CreateSet As B4XSet";
 //BA.debugLineNum = 10;BA.debugLine="Return CreateSet2(Null)";
if (true) return _vvvv2(_ba,(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(anywheresoftware.b4a.keywords.Common.Null)));
 //BA.debugLineNum = 11;BA.debugLine="End Sub";
return null;
}
public static elicorp.pilot.b4xset  _vvvv2(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.collections.List _values) throws Exception{
elicorp.pilot.b4xset _s = null;
Object _v = null;
...
_s._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 /*String*/ (_v);
 }
};
 };
