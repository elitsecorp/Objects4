...
public class keyvaluestore extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "elicorp.pilot.keyvaluestore");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", elicorp.pilot.keyvaluestore.class).invoke(this, new Object[] {null});
        else
...
public anywheresoftware.b4a.randomaccessfile.B4XSerializator _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = null;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = new anywheresoftware.b4a.randomaccessfile.B4XSerializator();
...
if (true) return (double)(Double.parseDouble(_vvvvvvvvvv1.ExecQuerySingleResult2("SELECT count(key) FROM main WHERE key = ?",new String[]{_key})))>0;
...
_vvvvvvvvvv1.ExecNonQuery("CREATE TABLE IF NOT EXISTS main(key TEXT PRIMARY KEY, value NONE)");
 //BA.debugLineNum = 176;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvv2() throws Exception{
 //BA.debugLineNum = 161;BA.debugLine="Public Sub DeleteAll";
 //BA.debugLineNum = 162;BA.debugLine="sql1.ExecNonQuery(\"DROP TABLE main\")";
_vvvvvvvvvv1.ExecNonQuery("DROP TABLE main");
...
_rs = (anywheresoftware.b4a.sql.SQL.ResultSetWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.sql.SQL.ResultSetWrapper(), (android.database.Cursor)(_vvvvvvvvvv1.ExecQuery2("SELECT value FROM main WHERE key = ?",new String[]{_key})));
...
_result = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.ConvertBytesToObject(_rs.GetBlob2((int) (0)));
 };
...
public anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper  _vvvvvvvvvvvvvvvvvvvvv5(String _key) throws Exception{
byte[] _b = null;
...
_b = (byte[])(_vvvvvvvvvvvvvvvvvvvvvvvvvvvv5(_key));
...
public Object  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7(String _key,Object _defaultvalue) throws Exception{
Object _res = null;
...
_res = _vvvvvvvvvvvvvvvvvvvvvvvvvvvv5(_key);
...
public anywheresoftware.b4a.keywords.Common.ResumableSubWrapper  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6(anywheresoftware.b4a.objects.collections.List _keys) throws Exception{
...
public ResumableSub_GetMapAsync(elicorp.pilot.keyvaluestore parent,anywheresoftware.b4a.objects.collections.List _keys) {
this.parent = parent;
this._keys = _keys;
}
elicorp.pilot.keyvaluestore parent;
...
_senderfilter = parent._vvvvvvvvvv1.ExecQueryAsync(ba,"SQL",_sb.ToString(),_keys);
...
parent.__c.LogImpl("931981591",BA.ObjectToString(parent.__c.LastException(parent.getActivityBA())),0);
 if (true) break;
...
if (_vvvvvvvvvv1.IsInitialized()) { 
_vvvvvvvvvv1.Close();};
 //BA.debugLineNum = 12;BA.debugLine="sql1.Initialize(Dir, FileName, True)";
_vvvvvvvvvv1.Initialize(_dir,_filename,__c.True);
 //BA.debugLineNum = 14;BA.debugLine="CreateTable";
_vvvv5();
 //BA.debugLineNum = 15;BA.debugLine="End Sub";
return "";
}
public anywheresoftware.b4a.objects.collections.List  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7() throws Exception{
...
_c = (anywheresoftware.b4a.sql.SQL.ResultSetWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.sql.SQL.ResultSetWrapper(), (android.database.Cursor)(_vvvvvvvvvv1.ExecQuery("SELECT key FROM main")));
...
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1(String _key,Object _value) throws Exception{
...
_vvvvvvvvvv1.ExecNonQuery2("INSERT OR REPLACE INTO main VALUES(?, ?)",anywheresoftware.b4a.keywords.Common.ArrayToList(new Object[]{(Object)(_key),(Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.ConvertObjectToBytes(_value))}));
 //BA.debugLineNum = 19;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0(String _key,anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper _value) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1(_key,(Object)(_out.ToBytesArray()));
 //BA.debugLineNum = 118;BA.debugLine="out.Close";
_out.Close();
 //BA.debugLineNum = 119;BA.debugLine="End Sub";
return "";
}
public anywheresoftware.b4a.keywords.Common.ResumableSubWrapper  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1(anywheresoftware.b4a.objects.collections.Map _map) throws Exception{
...
public ResumableSub_PutMapAsync(elicorp.pilot.keyvaluestore parent,anywheresoftware.b4a.objects.collections.Map _map) {
this.parent = parent;
this._map = _map;
}
elicorp.pilot.keyvaluestore parent;
...
parent._vvvvvvvvvv1.AddNonQueryToBatch("INSERT OR REPLACE INTO main VALUES(?, ?)",anywheresoftware.b4a.keywords.Common.ArrayToList(new Object[]{(Object)(_key),(Object)(_bytes)}));
 if (true) break;
...
parent.__c.LogImpl("932047112","Failed to serialize object: "+BA.ObjectToString(_map.Get((Object)(_key))),0);
 if (true) break;
...
_senderfilter = parent._vvvvvvvvvv1.ExecNonQueryBatch(ba,"SQL");
...
_vvvvvvvvvv1.ExecNonQuery2("DELETE FROM main WHERE key = ?",anywheresoftware.b4a.keywords.Common.ArrayToList(new Object[]{(Object)(_key)}));
 //BA.debugLineNum = 140;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2() throws Exception{
 //BA.debugLineNum = 179;BA.debugLine="Public Sub Vacuum";
 //BA.debugLineNum = 184;BA.debugLine="sql1.ExecNonQuery(\"VACUUM\")";
_vvvvvvvvvv1.ExecNonQuery("VACUUM");
