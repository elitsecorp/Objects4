...
public class b4xbytesbuilder extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "elicorp.pilot.b4xbytesbuilder");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", elicorp.pilot.b4xbytesbuilder.class).invoke(this, new Object[] {null});
        else
            ba.raiseEvent2(null, true, "class_globals", false);
    }

 public anywheresoftware.b4a.keywords.Common __c = null;
public byte[] _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = null;
...
public elicorp.pilot.b4xbytesbuilder  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvv3(byte[] _data) throws Exception{
...
if (true) return _vvvvvvvvvvvvvvvvvvvvvvvvvvvvv4(_data,(int) (0),_data.length);
 //BA.debugLineNum = 26;BA.debugLine="End Sub";
return null;
}
public elicorp.pilot.b4xbytesbuilder  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvv4(byte[] _data,int _startindex,int _length) throws Exception{
int _oldlength = 0;
...
_oldlength = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvv5((int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3+_length));
 //BA.debugLineNum = 33;BA.debugLine="Bit.ArrayCopy(Data, StartIndex, mBuffer, OldLengt";
__c.Bit.ArrayCopy((Object)(_data),_startindex,(Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2),_oldlength,_length);
 //BA.debugLineNum = 34;BA.debugLine="Return Me";
if (true) return (elicorp.pilot.b4xbytesbuilder)(this);
 //BA.debugLineNum = 35;BA.debugLine="End Sub";
return null;
}
public int  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvv5(int _newlength) throws Exception{
int _oldlength = 0;
byte[] _b = null;
...
_oldlength = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3;
 //BA.debugLineNum = 14;BA.debugLine="mLength = NewLength";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = _newlength;
 //BA.debugLineNum = 15;BA.debugLine="If mBuffer.Length < mLength Then";
if (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2.length<_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3) { 
 //BA.debugLineNum = 16;BA.debugLine="Dim b(Max(mBuffer.Length * 2, NewLength)) As Byt";
_b = new byte[(int) (__c.Max(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2.length*2,_newlength))];
;
 //BA.debugLineNum = 17;BA.debugLine="Bit.ArrayCopy(mBuffer, 0, b, 0, mBuffer.Length)";
__c.Bit.ArrayCopy((Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2),(int) (0),(Object)(_b),(int) (0),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2.length);
 //BA.debugLineNum = 18;BA.debugLine="mBuffer = b";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = _b;
 };
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = new byte[(int) (0)];
;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvv5((int) (0));
 //BA.debugLineNum = 39;BA.debugLine="End Sub";
return "";
}
public byte[]  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvv6() throws Exception{
 //BA.debugLineNum = 103;BA.debugLine="Private Sub getBuffer As Byte() 'ignore";
 //BA.debugLineNum = 104;BA.debugLine="End Sub";
return null;
}
public byte[]  _getvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0() throws Exception{
 //BA.debugLineNum = 127;BA.debugLine="Public Sub getInternalBuffer As Byte()";
 //BA.debugLineNum = 128;BA.debugLine="Return mBuffer";
if (true) return _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2;
 //BA.debugLineNum = 129;BA.debugLine="End Sub";
return null;
}
public int  _getvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1() throws Exception{
 //BA.debugLineNum = 92;BA.debugLine="Public Sub getLength As Int";
 //BA.debugLineNum = 93;BA.debugLine="Return mLength";
if (true) return _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3;
 //BA.debugLineNum = 94;BA.debugLine="End Sub";
return 0;
}
public int  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1(byte[] _searchfor) throws Exception{
...
if (true) return _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2(_searchfor,(int) (0));
 //BA.debugLineNum = 109;BA.debugLine="End Sub";
return 0;
}
public int  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2(byte[] _searchfor,int _index) throws Exception{
int _i1 = 0;
int _i2 = 0;
...
{
final int step1 = 1;
final int limit1 = (int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3-_searchfor.length);
_i1 = _index ;
...
if (_searchfor[_i2]!=_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2[(int) (_i1+_i2)]) { 
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = new byte[(int) (100)];
;
 //BA.debugLineNum = 8;BA.debugLine="mLength = 0";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = (int) (0);
 //BA.debugLineNum = 9;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3(int _index,byte[] _data) throws Exception{
...
if (_index>=_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3) { 
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvv3(_data);
 }else {
 //BA.debugLineNum = 48;BA.debugLine="Dim AfterIndex() As Byte = SubArray(Index)";
_afterindex = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5(_index);
 //BA.debugLineNum = 49;BA.debugLine="ChangeLength(mLength + Data.Length)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvv5((int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3+_data.length));
 //BA.debugLineNum = 50;BA.debugLine="Bit.ArrayCopy(Data, 0, mBuffer, Index, Data.Leng";
__c.Bit.ArrayCopy((Object)(_data),(int) (0),(Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2),_index,_data.length);
 //BA.debugLineNum = 51;BA.debugLine="Bit.ArrayCopy(AfterIndex, 0, mBuffer, Index + Da";
__c.Bit.ArrayCopy((Object)(_afterindex),(int) (0),(Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2),(int) (_index+_data.length),_afterindex.length);
 };
 //BA.debugLineNum = 53;BA.debugLine="End Sub";
return "";
}
public byte[]  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4(int _beginindex,int _endindex) throws Exception{
byte[] _res = null;
...
_res = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6(_beginindex,_endindex);
 //BA.debugLineNum = 71;BA.debugLine="If EndIndex <= mLength Then";
if (_endindex<=_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3) { 
 //BA.debugLineNum = 72;BA.debugLine="Dim AfterEndIndex() As Byte = SubArray(EndIndex)";
_afterendindex = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5(_endindex);
 //BA.debugLineNum = 73;BA.debugLine="Bit.ArrayCopy(AfterEndIndex, 0, mBuffer, BeginIn";
__c.Bit.ArrayCopy((Object)(_afterendindex),(int) (0),(Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2),_beginindex,_afterendindex.length);
 };
 //BA.debugLineNum = 75;BA.debugLine="ChangeLength(mLength - (EndIndex - BeginIndex))";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvv5((int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3-(_endindex-_beginindex)));
 //BA.debugLineNum = 76;BA.debugLine="Return res";
if (true) return _res;
 //BA.debugLineNum = 77;BA.debugLine="End Sub";
return null;
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvv7(int _index,byte[] _data) throws Exception{
...
if (_data.length+_index>_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3) { 
 //BA.debugLineNum = 62;BA.debugLine="ChangeLength(Data.Length + Index)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvv5((int) (_data.length+_index));
 };
...
public byte[]  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5(int _beginindex) throws Exception{
...
if (true) return _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6(_beginindex,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3);
 //BA.debugLineNum = 82;BA.debugLine="End Sub";
return null;
}
public byte[]  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6(int _beginindex,int _endindex) throws Exception{
byte[] _b = null;
...
__c.Bit.ArrayCopy((Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2),_beginindex,(Object)(_b),(int) (0),_b.length);
 //BA.debugLineNum = 89;BA.debugLine="Return b";
if (true) return _b;
 //BA.debugLineNum = 90;BA.debugLine="End Sub";
return null;
}
public byte[]  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7() throws Exception{
 //BA.debugLineNum = 97;BA.debugLine="Public Sub ToArray() As Byte()";
 //BA.debugLineNum = 98;BA.debugLine="Return SubArray(0)";
if (true) return _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5((int) (0));
